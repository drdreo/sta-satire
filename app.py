...
app.layout = html.Div([
    html.H1(children='Who is in fake News!'),
    html.Div([
...
The text-data comes from articles published by *Entenpost* agency on their website [www.entenpost.com](https://www.entenpost.com/).
'''),
        ], className='col-lg-4'),
...
as a funcion of time.'''
    ...
    dcc.Markdown('''**Imprint:**  [Andreas Hahn, Bsc. ](https://andreas-hahn.at)''')
], className='container')
